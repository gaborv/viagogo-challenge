...
{
	if (region.ar.O === region.aC.O)
	{
		return 'on line ' + region.ar.O;
	}
	return 'on lines ' + region.ar.O + ' through ' + region.aC.O;
}
...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		xhr.addEventListener('load', function() {
			callback(_Http_handleResponse(xhr, request.aE.a));
		});

		try
		{
			xhr.open(request.aT, request.bk, true);
		}
		catch (e)
		{
			return callback(_Scheduler_fail(elm$http$Http$BadUrl(request.bk)));
		}
...
function _Http_configureRequest(xhr, request)
{
	...
	xhr.responseType = request.aE.b;
	xhr.withCredentials = request.bn;

	elm$core$Maybe$isJust(request.bh) && (xhr.timeout = request.bh.a);
}
...
function _Http_toResponse(xhr)
{
	return {
		bk: xhr.responseURL,
		bS: { bw: xhr.status, w: xhr.statusText },
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bE: 'hidden', N: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bE: 'mozHidden', N: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bE: 'msHidden', N: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bE: 'webkitHidden', N: 'webkitvisibilitychange' }
		: { bE: 'hidden', N: 'visibilitychange' };
}
		...
		return elm$http$Http$request(
			{
				...
				aE: elm$http$Http$expectJson(decoder),
				aJ: _List_fromArray(
					[
...
var author$project$Event$Event = F5(
	function (minimumPrice, numberOfTickets, startsAt, listingsUrl, venue) {
		return {bH: listingsUrl, bJ: minimumPrice, bM: numberOfTickets, bR: startsAt, bU: venue};
	});
...
var elm$parser$Parser$Advanced$run = F2(
	function (_n0, src) {
		var parse = _n0;
		var _n1 = parse(
			{ay: 1, c: _List_Nil, e: 1, b: 0, a8: 1, a: src});
		if (!_n1.$) {
			var value = _n1.b;
			return elm$core$Result$Ok(value);
		} else {
...
var isaacseymour$deprecated_time$Time$Date$dateFromDays = function (ds) {
	...
	var _n0 = (doy < 31) ? _Utils_Tuple2(0, doy + 1) : ((_Utils_cmp(
		doy,
	...
	var month_ = _n0.a;
	var day_ = _n0.b;
	return {az: day_, aV: month_, bo: year_ + (y400 * 400)};
};
...
var isaacseymour$deprecated_time$Time$Date$addDays = F2(
	function (days, _n0) {
		...
		return isaacseymour$deprecated_time$Time$Date$dateFromDays(
			days + A3(isaacseymour$deprecated_time$Time$Date$daysFromYearMonthDay, d.bo, d.aV, d.az));
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{ay: col, c: s0.c, e: s0.e, b: offset, a8: row, a: s0.a});
			} else {
...
var elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5(elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.a8, s.ay, s);
	};
};
...
var elm$parser$Parser$Advanced$Located = F3(
	function (row, col, context) {
		return {ay: col, c: context, a8: row};
	});
var elm$parser$Parser$Advanced$changeContext = F2(
	function (newContext, s) {
		return {ay: s.ay, c: newContext, e: s.e, b: s.b, a8: s.a8, a: s.a};
	});
		...
		return function (s0) {
			var _n1 = parse(
				A2(
					...
					A2(
						elm$core$List$cons,
						A3(elm$parser$Parser$Advanced$Located, s0.a8, s0.ay, context),
						s0.c),
					s0));
			if (!_n1.$) {
				var p = _n1.a;
...
var elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {ay: col, bx: contextStack, a0: problem, a8: row};
	});
...
var elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4(elm$parser$Parser$Advanced$DeadEnd, s.a8, s.ay, x, s.c));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{ay: 1, c: s.c, e: s.e, b: s.b + 1, a8: s.a8 + 1, a: s.a}) : A3(
				elm$parser$Parser$Advanced$Good,
				true,
				0,
				{ay: s.ay + 1, c: s.c, e: s.e, b: newOffset, a8: s.a8, a: s.a}));
		};
	});
...
var isaacseymour$deprecated_time$Time$Iso8601$IntermediateOffset = F4(
	function (hours, minutes, seconds, milliseconds) {
		return {aM: hours, ao: milliseconds, aU: minutes, bb: seconds};
	});
...
var isaacseymour$deprecated_time$Time$Iso8601$convertTime = function (intermediate) {
	return elm$parser$Parser$Advanced$succeed(
		isaacseymour$deprecated_time$Time$Internal$offsetFromTimeData(
			{aa: intermediate.aM, ab: intermediate.ao, ac: intermediate.aU, af: intermediate.bb}));
};
...
var elm$parser$Parser$Advanced$token = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, str, s.b, s.a8, s.ay, s.a);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{ay: newCol, c: s.c, e: s.e, b: newOffset, a8: newRow, a: s.a});
	};
};
...
var author$project$EventList$init = function (flags) {
	var apiRequest = A2(
		...
		A2(author$project$Event$getEvents, flags.Z, flags.Y));
...
var isaacseymour$deprecated_time$Time$Date$month = function (_n0) {
	var inner = _n0;
	return isaacseymour$deprecated_time$Time$Date$monthToInt(inner.aV);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(event.bU.bL),
						elm$html$Html$text('––'),
						elm$html$Html$text(event.bU.bv)
					])),
				A2(
				elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(
						author$project$EventList$monthAbbrv(event.bR)),
						elm$html$Html$text(
						elm$core$String$fromInt(
							isaacseymour$deprecated_time$Time$DateTime$day(event.bR))),
						elm$html$Html$text(', '),
						elm$html$Html$text(
						elm$core$String$fromInt(
							isaacseymour$deprecated_time$Time$DateTime$hour(event.bR))),
						elm$html$Html$text(
						elm$core$String$fromInt(
							isaacseymour$deprecated_time$Time$DateTime$minute(event.bR)))
					]))
			]));
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aH: fragment, aL: host, aZ: path, a$: port_, a3: protocol, a4: query};
	});
...
var author$project$EventList$main = elm$browser$Browser$element(
	{
		aN: author$project$EventList$init,
		bf: function (_n0) {
			return elm$core$Platform$Sub$none;
		},
		bj: author$project$EventList$update,
		bl: author$project$EventList$view
	});
_Platform_export({'EventList':{'init':author$project$EventList$main(
	A2(
							...
							return A2(
								...
								function (accessToken) {
									return elm$json$Json$Decode$succeed(
										{Y: accessToken, Z: artistId, al: latitude, am: longitude});
								},
		...
		A2(elm$json$Json$Decode$field, 'longitude', elm$json$Json$Decode$float)))(0)}});}(this));